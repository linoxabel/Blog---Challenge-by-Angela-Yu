...
app.patch('/posts/:id', (req, res) => {
  ...
  posts[postToChange] = {
    id: req.body.id || posts[postToChange].id,
    title: req.body.title || posts[postToChange].title,
    content: req.body.content || posts[postToChange].content,
    author: req.body.author || posts[postToChange].author
  };
  res.json(posts);
});
